...
namespace df {
	...
	void Road::upgrade() {
		switch (roadLevel) {
		case RoadLevel::Path:
			roadLevel = RoadLevel::DirtRoad;
			break;
		case RoadLevel::DirtRoad:
			roadLevel = RoadLevel::StoneRoad;
			break;
		case RoadLevel::StoneRoad:
			roadLevel = RoadLevel::HighQualityRoad;
			break;
		// alredy maxed out
		case RoadLevel::HighQualityRoad:
			return;
		}
	}
